      ...
      test('Test POST /api/books with no title given', function (done) {
        chai.request(server)
          ...
          .end(function (err, res) {
            ...
            assert.equal(res.body, 'missing required field title', 'String error returned when no title be provided');
            done();
          });
      });
      ...
      test('Test GET /api/books/[id] with id not in db', function (done) {
        chai.request(server)
          ...
          .end(function (err, res) {
            assert.equal(res.status, 200);
            assert.isString(res.body, 'response should be an string');
            assert.equal(res.body, 'no book exists', 'String error returned when id is invalid');
            done();
          });
      });
          ...
          .end(function (err, res) {
            ...
            chai.request(server)
              ...
              .end(function (err, res) {
                ...
                assert.property(res.body, 'title', 'Book should contain title');
                assert.property(res.body, '_id', 'Book should contain _id');
                assert.equal(res.body._id, validId, 'Book _id should be the same that requsted _id');
                done();
              });
          });
      });
    ...
    suite('POST /api/books/[id] => add comment/expect book object with id', function () {
          ...
          .end(function (err, res) {
            ...
            chai.request(server)
              ...
              .end(function (err, res) {
                ...
                assert.property(res.body, '_id', 'Book should contain _id');
                assert.equal(res.body._id, validId, 'Book _id should be the same that requsted _id');
                assert.isAtLeast(res.body.commentcount, 1, 'At least one comment');
                done();
              });
          });
      });
          ...
          .end(function (err, res) {
            ...
            chai.request(server)
              ...
              .end(function (err, res) {
                ...
                assert.equal(res.body, 'missing required field comment', 'Should return error with no comment');
                done();
              });
          });
      });
      ...
      test('Test POST /api/books/[id] with comment, id not in db', function (done) {
        ...
        .end(function (err, res) {
          assert.equal(res.status, 200);
          assert.isString(res.body, 'response should be a string');
          assert.equal(res.body, 'no book exists', 'Should return no book exists');
          done();
        });
      });
